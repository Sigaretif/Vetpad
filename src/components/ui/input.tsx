  ...
  return (
    <input
      ...
      className={cn(
        ...
        // Deviation from the registry (dark:aria-invalid:ring-destructive/40, 1,98:1): the focus
        // ring on an errored field needs >=3:1 (research T9). /70 gives 3,62:1 on card.
